...
import { genAiSessions } from "./genAiSessions";

const HERO_IMAGE_URL =
  "https://i.ibb.co/2YYjyHp0/Gemini-Generated-Image-u6v74du6v74du6v7.webp";

const copy = {
  ar: {
    breadcrumbHome: "الرئيسية",
    breadcrumbCategory: "المناهج",
    title: "منهج الذكاء الاصطناعي التوليدي",
    meta: "12 جلسة",
    mode: "أونلاين 1:1 خاص",
    summary:
      "رحلة عملية وآمنة تساعد الأطفال على فهم الذكاء الاصطناعي واستخدامه في التفكير والكتابة والتصميم والإبداع.",
    paragraph1:
      "هذا المنهج مصمم للأطفال الذين يريدون اكتشاف أدوات الذكاء الاصطناعي بطريقة منظمة ومناسبة لأعمارهم.",
    paragraph2:
      "سيتعلم الطفل كتابة البرومبت، إنشاء القصص والصور والأفكار، التحقق من الإجابات، وبناء مشروع نهائي يوضح استخدامه الإبداعي والآمن للذكاء الاصطناعي.",
    details: "تفاصيل المنهج",
    detailTitle: "منهج الذكاء الاصطناعي التوليدي: 12 جلسة",
    session: "الجلسة",
  },
  en: {
    breadcrumbHome: "HOME",
    ...
    summary:
      "A safe, hands-on journey where kids learn how AI works and use it for thinking, writing, design, and creativity.",
    paragraph1:
      "This curriculum is designed for kids who want to explore AI tools in a structured, age-appropriate way.",
    paragraph2:
      "Students learn prompting, story and image creation, idea generation, fact-checking, chatbot planning, and a final AI showcase project.",
    details: "CURRICULUM DETAILS",
    detailTitle: "Gen AI Curriculum: 12 Sessions",
    session: "Session",
  },
};
...
export default function GenAICurriculum() {
  ...
  useEffect(() => {
    document.title = "Gen AI Curriculum - SP School";
  }, []);
