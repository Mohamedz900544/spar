...
import { automationSessions } from "./automationSessions";

const HERO_IMAGE_URL = "https://i.ibb.co/xVTp1PK/2962489.webp";

const copy = {
  ar: {
    breadcrumbHome: "الرئيسية",
    breadcrumbCategory: "المناهج",
    title: "منهج الأتمتة والسكريبتنج",
    meta: "12 جلسة",
    mode: "أونلاين 1:1 خاص",
    summary:
      "رحلة عملية يتعلم فيها الطالب كيف يحول المهام المتكررة إلى مسارات عمل ذكية باستخدام Python وأدوات بسيطة.",
    paragraph1:
      "هذا المنهج مناسب للطلاب الأكبر سنا الذين يريدون فهم كيف توفر الأتمتة الوقت وتربط الملفات والبيانات والويب والإشعارات.",
    paragraph2:
      "سيتعلم الطالب تنظيم الملفات، قراءة CSV وExcel، استخدام APIs، بناء تنبيهات، أتمتة الويب، وإنشاء مشروع نهائي يعرض أثر الأتمتة.",
    details: "تفاصيل المنهج",
    detailTitle: "منهج الأتمتة والسكريبتنج: 12 جلسة",
    session: "الجلسة",
  ...
  en: {
    ...
    title: "Automation & Scripting Curriculum",
    meta: "12 Sessions",
    mode: "Online 1:1 Private",
    summary:
      "A practical journey where students turn repeated tasks into smart workflows using Python and simple digital tools.",
    paragraph1:
      "This curriculum is built for older students who want to understand how automation saves time and connects files, data, web tools, and notifications.",
    paragraph2:
      "Students learn file organization, CSV and Excel workflows, APIs, reminders, safe web automation, dashboards, and a final automation showcase.",
    details: "CURRICULUM DETAILS",
    detailTitle: "Automation & Scripting Curriculum: 12 Sessions",
    session: "Session",
...
export default function AutomationCurriculum() {
  ...
  useEffect(() => {
    document.title = "Automation & Scripting Curriculum - SP School";
  }, []);
