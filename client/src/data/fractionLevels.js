...
// Each level is a grid. "highlighted" are the purple cell indexes.
export const FRACTION_LEVELS = [
  {
    ...
    // cells: 0 1
    //        2 3
    highlighted: [0], // 1 of 4 = 1/4 (purple)
    cellColors: ["#a855f7", "#2563eb", "#ef4444", "#2563eb"],
    grade: "2",
    tags: ["quarters", "area model"],
    labels: [
      { cellIndex: 0, text: "1/4" }, // purple
      { cellIndex: 2, text: "1/4" }, // red
      { cellIndex: 1, text: "1/2" }, // blue (right column)
    ],
  },
  {
    id: "half-rectangle",
